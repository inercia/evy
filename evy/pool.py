...
class Pool(object):
    ...
    def execute (self, func, *args, **kwargs):
        ...
        Immediately returns a :class:`~evy.proc.Proc` object which can be
    ...
    def generate_results (self, function, iterable, qsize = None):
        ...
        *iterable*. Unlike :meth:`wait_all` and :meth:`process_all`, this
        ...
        executes coroutines at least as aggressively as the classic evy
        idiom::
