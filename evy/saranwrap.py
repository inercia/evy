...
from evy.processes import Process, DeadProcess
from evy import pools

import warnings

warnings.warn("evy.saranwrap is deprecated due to underuse.  If you love "
              "it, let us know by emailing evydev@lists.secondlife.com",
...
def status (proxy):
    ...
    :param proxy: a :class:`evy.saranwrap.Proxy` object connected to a
        server.
    """
