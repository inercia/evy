...
# adapted from https://github.com/srlindsay/gevent-profiler


"""
This module provides a simple way to get detailed profiling information
about a Python process that uses the `evy` library.  The normal Python
profilers are not nearly as useful in this context, due to `evy`'s
