...
from evy.hubs.hub import FdListener, READ, WRITE

class DelayedCall(TwistedDelayedCall):
    "fix DelayedCall to behave like evy's Timer in some respects"
...
class TwistedHub(BaseTwistedHub):
    ...
    # unlike other evy hubs, which are created per-thread,
