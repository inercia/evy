...
tweaks in the :mod:`~evy.wsgi` module that allow websockets to
...
As of version 0.9.13, evy.websocket supports SSL websockets; all that's necessary is to use an :ref:`SSL wsgi server <wsgi_ssl>`.
